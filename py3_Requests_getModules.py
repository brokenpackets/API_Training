...
get_inventory = ['enable', 'show inventory']
get_module = ['enable', 'show module']
outputlist = []
...
def main():
    for switch in devicelist:
        ...
        inventory = eapi(switch,get_version)['result'][1]
        module = eapi(switch,get_version)['result'][1]
    outputlist.append({"hostname": hostname, "version": version, "inventory": inventory, "module": module})
    print('-------Devices--------')
